...
export class PageService {
  ...
  update(page: IPage): Observable<EntityResponseType> {
    return this.http.put<IPage>(`${this.resourceUrl}/${getPageIdentifier(page) as string}`, page, { observe: 'response' });
  }

  partialUpdate(page: IPage): Observable<EntityResponseType> {
    return this.http.patch<IPage>(`${this.resourceUrl}/${getPageIdentifier(page) as string}`, page, { observe: 'response' });
  }
