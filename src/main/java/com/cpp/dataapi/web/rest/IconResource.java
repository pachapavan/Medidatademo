...
/**
 * REST controller for managing {@link com.cpp.dataapi.domain.Icon}.
 */
@RestController
@RequestMapping("/api")
public class IconResource {
     ...
     */
    @PutMapping("/icons/{id}")
    public ResponseEntity<Icon> updateIcon(@PathVariable(value = "id", required = false) final String id, @RequestBody Icon icon)
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, icon.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<Icon> partialUpdateIcon(@PathVariable(value = "id", required = false) final String id, @RequestBody Icon icon)
        throws URISyntaxException {
        ...
        return ResponseUtil.wrapOrNotFound(result, HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, icon.getId()));
    }
     ...
     */
    @GetMapping("/icons/{id}")
    public ResponseEntity<Icon> getIcon(@PathVariable String id) {
