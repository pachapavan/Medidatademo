...
/**
 * REST controller for managing {@link com.cpp.dataapi.domain.Badge}.
 */
@RestController
@RequestMapping("/api")
public class BadgeResource {
    ...
    public ResponseEntity<Badge> updateBadge(@PathVariable(value = "id", required = false) final String id, @RequestBody Badge badge)
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, badge.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<Badge> partialUpdateBadge(
        ...
        return ResponseUtil.wrapOrNotFound(result, HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, badge.getId()));
    }
