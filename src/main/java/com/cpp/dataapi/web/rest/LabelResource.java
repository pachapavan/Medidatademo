...
/**
 * REST controller for managing {@link com.cpp.dataapi.domain.Label}.
 */
@RestController
@RequestMapping("/api")
public class LabelResource {
    ...
    public ResponseEntity<Label> updateLabel(@PathVariable(value = "id", required = false) final String id, @RequestBody Label label)
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, label.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<Label> partialUpdateLabel(
        ...
        return ResponseUtil.wrapOrNotFound(result, HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, label.getId()));
    }
