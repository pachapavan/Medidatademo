...
/**
 * REST controller for managing {@link com.cpp.dataapi.domain.Image}.
 */
@RestController
@RequestMapping("/api")
public class ImageResource {
    ...
    public ResponseEntity<Image> updateImage(@PathVariable(value = "id", required = false) final String id, @RequestBody Image image)
